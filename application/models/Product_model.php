...
class Product_model extends CI_Model {
    ...
    public function get_all_products()
    {
        ...
        SELECT p.* FROM products p JOIN ( SELECT oi.product_id, COUNT(oi.product_id) as total_sold FROM order_item oi GROUP BY oi.product_id ORDER BY total_sold DESC LIMIT 5 ) top_products ON p.id = top_products.product_id
    ")->result();
