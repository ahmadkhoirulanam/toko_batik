...
<!-- Header -->
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 d-inline-block mb-0">Dasbor</h6>
            </div>
            <div class="col-lg-6 col-5 text-right">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                 
                  <li class="breadcrumb-item active text-red" aria-current="page">Dasbor</li>
    ...
    <!-- Page content -->
    <p>
    <div class="card-body bg-gradient-red ml-4 mr-3">
      <div class="row">
              ...
              <?php foreach ($customers as $customer) : ?>
                <li class="list-group-item px-0">
                  <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                      <a href="<?php echo site_url('admin/customers/view/'. $customer->id); ?>" class="btn btn-sm btn-danger">Profil</a>
                    </div>
                  </div>
                </li>
                <?php endforeach; ?>
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="<?php echo site_url('admin/products'); ?>" class="btn btn-sm btn-danger">Lihat semua</a>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="<?php echo site_url('admin/products/category'); ?>" class="btn btn-sm btn-danger">Lihat semua</a>
                </div>
              </div>
            </div>
            <div class="table-responsive">
